    ...
    <div className="w-full space-y-4 animate-in fade-in duration-700 pb-10">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button onClick={() => router.push('/compliance/review-queue')} variant="outline" size="sm" className="h-9 rounded-xl border-border font-bold text-muted-foreground bg-card shadow-sm flex items-center gap-2 hover:bg-secondary hover:text-foreground relative">
        ...
        <div className="bg-card border border-border rounded-[20px] overflow-hidden flex flex-col min-w-0 shadow-sm">
          <div className="px-5 py-3 border-b border-border flex items-center justify-between bg-background sticky top-0 z-10">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button onClick={() => toast.info('Filters Reset', { description: 'All search and status filters cleared.' })} className="h-10 rounded-xl font-black text-[10px] uppercase tracking-widest bg-primary text-white shadow-lg shadow-primary/20 flex items-center gap-2">
                    ...
                    <td className="px-4 py-2 text-xs">
                      <div className="space-y-1">
                        <div className="flex items-center justify-between text-[8px] font-bold mb-1">
                          <span className={cn(txn.risk > 0.5 ? "text-rose-600 dark:text-rose-500" : "text-emerald-600 dark:text-emerald-500")}>{(txn.risk * 100).toFixed(0)}% RISK</span>
                        </div>
