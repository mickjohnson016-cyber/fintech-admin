...
"text-[9px] font-black px-1.5 py-0.5 rounded-lg",
 ...
 <Button 
  ...
  variant="ghost" 
  size="icon" 
  className="h-8 w-8 bg-muted border border-border text-muted-foreground hover:text-primary rounded-xl"
  >
  <Download size={16} />
  </Button>
 </div>
 ...
 <td className="px-4 py-2.5 text-center"><Badge className={cn("text-[8px] border", row.status ==='Active' ?'bg-emerald-500/10 text-emerald-600 border-emerald-500/20' : row.status ==='Matured' ?'bg-primary/10 text-primary border-primary/20' :'bg-amber-500/10 text-amber-600 border-amber-500/20')}>{row.status}</Badge></td>
 <td className="px-4 py-2.5 text-center"><Badge className={cn("text-[8px] border", row.risk ==='Low' ?'bg-emerald-500/10 text-emerald-600 border-emerald-500/20' :'bg-amber-500/10 text-amber-600 border-amber-500/20')}>{row.risk}</Badge></td>
