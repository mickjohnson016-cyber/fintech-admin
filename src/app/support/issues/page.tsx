...
"bg-muted/50 text-muted-foreground border-border/50"
 ...
 size="icon" 
 className={cn(
"size-8 rounded-md text-muted-foreground transition-all hover:bg-muted",
 activeMenuId === ticket.id &&"bg-muted text-foreground"
 )}
 onClick={(e) => {
 e.stopPropagation();
 ...
 exit={{ opacity: 0, y: 5 }}
 className="absolute right-0 top-full mt-1 w-48 bg-card border border-border shadow-lg rounded-lg z-20 overflow-hidden p-1 pointer-events-auto"
 ...
 className={cn(
"w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-[13px] font-medium text-muted-foreground hover:bg-muted hover:text-foreground transition-colors",
 item.className
 )}
 >
 ...
 className="w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-[13px] font-medium text-rose-600 hover:bg-rose-500/5 transition-colors"
 >
 <Trash2 size={14} strokeWidth={2.5} /> Delete Ticket
 </button>
 </motion.div>
 </>
 )}
