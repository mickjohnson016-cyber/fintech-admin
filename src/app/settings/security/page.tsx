  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        <div className="xl:col-span-2 space-y-8">
          ...
          <SettingsCard 
            ...
            description="Devices currently signed into your administrative account."
            icon={Monitor}
          >
          ...
          <SettingsCard 
            ...
            description="Restricted IP addresses and access whitelisting for backend communication."
            icon={Globe}
          >
        ...
        <div className="space-y-8">
          ...
          <div className="p-8 bg-card border border-border/40 rounded-[40px] space-y-6 shadow-sm overflow-hidden relative group">
             ...
             <Button className="w-full h-11 rounded-xl bg-primary text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20">Analyze Vulnerabilities</Button>
          </div>
      ...
      <QuickActionModal
        ...
        description="This device will be forced to log out immediately. All active operations will be terminated."
        icon={LogOut}
        type="danger"
      ...
      <QuickActionModal
        ...
        description="Enter the IP address or CIDR range to authorize for backend access."
        icon={Globe}
