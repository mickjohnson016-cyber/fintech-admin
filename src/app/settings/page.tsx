        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <div className="bg-card/50 backdrop-blur-md border border-border/50 rounded-[32px] p-6 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <button 
                onClick={() => toastActions.showActionToast('Audit Explorer', 'Loading deep operational trail...')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4 border-l border-border/20 pl-6">
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full py-2 bg-primary text-white text-[9px] font-black uppercase tracking-widest rounded-lg hover:bg-primary/90 transition-all">
