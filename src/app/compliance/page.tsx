...
"px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all",
 ...
 <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 min-w-[200px]">Customer</th>
 <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 min-w-[180px]">Submission</th>
 <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 min-w-[150px]">Risk Score</th>
 <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 min-w-[120px]">Status</th>
...
"px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest text-white shadow-lg",
 ...
 className="fixed right-0 top-0 h-full w-full lg:max-w-2xl bg-card border-l border-border/50 z-[101] shadow-2xl flex flex-col"
 >
 <div className="p-6 sm:p-8 border-b border-border/20 flex items-start justify-between bg-secondary/10">
