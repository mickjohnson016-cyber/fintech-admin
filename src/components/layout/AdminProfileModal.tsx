            ...
            >
              ...
              <div className="w-full md:w-72 bg-secondary/30 border-r border-border/20 p-8 flex flex-col shrink-0">
                ...
                <div className="pt-6 mt-auto border-t border-border/10">
                  <button 
                    onClick={() => { setIsProfileOpen(false); toast.info('Session Ended'); }}
              ...
              <div className="flex-1 flex flex-col overflow-hidden relative">
                <button 
                  onClick={() => setIsProfileOpen(false)}
                  className="absolute top-8 right-8 p-2 bg-secondary/50 hover:bg-secondary border border-border/20 rounded-xl text-muted-foreground transition-all z-20"
                >
                  <X size={20} />
                </button>
                  ...
                  <AnimatePresence mode="wait">
                    {activeTab === 'profile' ? (
                      ...
                      >
                        ...
                        <div className="flex flex-col xl:flex-row gap-12 items-start">
                          ...
                          <div className="space-y-6 shrink-0">
                             <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                                <div className="size-32 rounded-[40px] bg-secondary border-4 border-card shadow-2xl flex items-center justify-center overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center text-white rounded-[40px] gap-1">
                                  <Camera size={24} />
                        ...
                        {/* Security & Preferences Section - Sanitized */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                           ...
                           <div className="space-y-6">
                              ...
                              <div className="space-y-4">
                                 <div className="flex items-center justify-between p-4 bg-secondary/10 border border-border/5 rounded-2xl">
                                    <div className="space-y-1">
                                       <p className="text-[12px] font-black text-foreground">Active Sessions</p>
                                       <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest">No other sessions</p>
                                    </div>
                                    <Monitor size={16} className="text-muted-foreground/30" />
                                 </div>
                                 <div className="flex items-center justify-between p-4 bg-secondary/10 border border-border/5 rounded-2xl">
                                    <div className="space-y-1">
                                       <p className="text-[12px] font-black text-foreground">Two-Factor Auth</p>
                                       <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest">Not initialized</p>
                                    </div>
                           ...
                           <div className="space-y-6">
                              ...
                              <div className="space-y-4">
                                 <div className="flex items-center justify-between p-4 bg-secondary/10 border border-border/5 rounded-2xl">
                                    <div className="space-y-1">
                                       <p className="text-[12px] font-black text-foreground">Default View</p>
                                       <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest">Not configured</p>
                                    </div>
                                    <Globe size={16} className="text-muted-foreground/30" />
                                 </div>
                                 <div className="flex items-center justify-between p-4 bg-secondary/10 border border-border/5 rounded-2xl">
                                    <div className="space-y-1">
                                       <p className="text-[12px] font-black text-foreground">Data Format</p>
                                       <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest">Platform default</p>
                                    </div>
                        ...
                        {/* Recent Profile Activity - Sanitized */}
                        <div className="space-y-6">
                           <div className="flex items-center gap-2 border-b border-border/10 pb-4">
                              <Activity size={16} className="text-primary" />
                              <h4 className="text-[11px] font-black uppercase tracking-widest text-foreground">Identity Logs</h4>
                           </div>
                           <div className="py-12 text-center border-2 border-dashed border-border/10 rounded-[32px] opacity-30">
                              <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground">No recent activity available</p>
                           </div>
                        </div>
                      </motion.div>
                    ) : (
