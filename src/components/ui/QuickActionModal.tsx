...
export function QuickActionModal({
  ...
  const getTypeStyles = () => {
    switch (type) {
      case 'danger': return { color: 'text-rose-600 dark:text-rose-400', bg: 'bg-rose-50 dark:bg-rose-500/10', button: 'bg-rose-600 hover:bg-rose-700 dark:bg-rose-500 dark:hover:bg-rose-600' };
      case 'success': return { color: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-50 dark:bg-emerald-500/10', button: 'bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600' };
      default: return { color: 'text-primary', bg: 'bg-primary/5 dark:bg-primary/10', button: 'bg-primary hover:bg-primary/90' };
    }
  };
