...
export default function SettingsField({ 
 ...
 <div className="flex-1 flex justify-start sm:justify-end items-center w-full sm:w-auto">
 <div className="w-full sm:w-auto flex justify-start sm:justify-end min-w-0">
 {children}
 </div>
 </div>
 </div>
