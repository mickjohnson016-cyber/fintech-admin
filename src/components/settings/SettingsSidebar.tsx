...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "api", label: "API & Integrations", icon: Code2, href: "/settings/api" },
...
export default function SettingsSidebar() {
  ...
  return (
    <div className="w-full lg:w-72 flex flex-col gap-8 sticky top-8 h-[calc(100vh-10rem)] overflow-y-auto pr-4 scrollbar-hide">
      {/* Search Settings */}
