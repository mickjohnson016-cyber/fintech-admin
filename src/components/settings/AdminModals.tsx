...
export const RoleModal = ({ 
 ...
 className={cn(
"relative flex flex-col items-center gap-3 p-4 rounded-3xl border-2 border-dashed transition-all group overflow-hidden",
 formData.avatar ==='custom' 
 ?"border-primary bg-primary/5 ring-4 ring-primary/5" 
 :"border-border/20 bg-secondary/10 hover:border-primary/30 hover:bg-secondary/20"
 )}
 >
 <div className="size-12 rounded-2xl overflow-hidden border border-border/20 shadow-inner flex items-center justify-center bg-background group-hover:scale-110 transition-transform">
 {previewUrl ? (
 ...
 className="absolute top-1.5 right-1.5 size-6 bg-rose-500 text-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity shadow-lg z-10"
 >
...
"flex flex-col items-center gap-3 p-4 rounded-3xl border-2 transition-all group",
 ...
 <span className="text-[9px] font-black uppercase tracking-widest text-muted-foreground group-hover:text-primary transition-colors">{avatar.name}</span>
 </button>
 ))}
 </div>
 </div>
